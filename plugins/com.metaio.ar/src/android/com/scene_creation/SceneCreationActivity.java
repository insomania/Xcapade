        ...
        FragmentMarkerManagement.OnFragmentMarkerManagementInteractionListener
{
    ...
    private String sceneNameAWS;
    private String sceneDescAWS;
    private String sceneHintAWS;
...
//    }
    ...
    @Override
    public void onSceneSavingConfirmed(String name, String descr, String hint)
    {
        sceneNameAWS = name;
        sceneDescAWS = descr;
        sceneHintAWS = hint;

        saveScene(name, descr, hint);
    ...
    private void saveScene(String sceneName, String sceneDescr, String sceneHint)
    {
        // get date/time
        ...
        mSavedSceneModels = ARSceneXML.saveScene(TRACKING_CONFIG_TEMP_PATH, SAVE_FOLDER_PATH,
                sceneName, sceneDescr, sceneHint,
    ...
    public void onUploadButton(View view) throws UnsupportedEncodingException {
        ...
        urlParameters = urlParameters + "&Scene_name=" + URLEncoder.encode(sceneNameAWS, "UTF-8");
        urlParameters = urlParameters + "&Scene_desc=" + URLEncoder.encode(sceneDescAWS, "UTF-8");
        urlParameters = urlParameters + "&Scene_hint=" + URLEncoder.encode(sceneHintAWS, "UTF-8");
        ...
        (new FetchRtmpURL(targetURL, urlParameters)).execute();
...
//        }
    ...
    private void setCurrentCOSVisible(final int cosID, final boolean visible)
    {
        ...
        runOnUiThread(new Runnable()
        {
            ...
            public void run()
            {
                ...
                View btnAddModel = findViewById(R.id.insert_model_button);
                View btnRemoveModel = findViewById(R.id.delete_model_button);
                if (btnAddModel!=null && btnRemoveModel!=null)
                {
                    btnAddModel.setVisibility(visible ? View.VISIBLE : View.GONE);
                    btnRemoveModel.setVisibility(visible ? View.VISIBLE : View.GONE);
                }
            }
        });
    }
    ...
    public void onInsertModelButton(View view)
    {
    ...
    public void onDeleteModelButton(View view)
    {
