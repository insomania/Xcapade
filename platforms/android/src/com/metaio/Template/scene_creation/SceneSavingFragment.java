...
public class SceneSavingFragment extends DialogFragment
{
                             ...
                             Bundle savedInstanceState)
    {
        ...
        if (mListener != null)
        {
            ...
            if(spotStoreData[2] == null || spotStoreData[2].trim().isEmpty()) {
                spotStoreData[2] = "A simple spot with an Xcapade chest.";
            }
            if(spotStoreData[3] == null || spotStoreData[3].trim().isEmpty()) {
                spotStoreData[3] = "No hint available";
            }
