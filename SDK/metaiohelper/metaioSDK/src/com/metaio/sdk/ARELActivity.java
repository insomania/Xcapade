...
public class ARELActivity extends ARViewActivity
{
	 ...
	 */
	protected ARELInterpreterAndroidJava2 mARELInterpreter;
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		mARELInterpreter = new ARELInterpreterAndroidJava2();
	...
	public static synchronized boolean writeToFile(Bitmap bitmap, CompressFormat format, int quality, String directory, String filename, boolean deleteOnExit) throws IOException
	{
		...
		try
		{
			...
			if (!saveToGalleryWithoutDialog)
			{
				...
				final boolean result =
						writeToFile(bitmap, CompressFormat.JPEG, 100, cacheDirPath, filename, false);
